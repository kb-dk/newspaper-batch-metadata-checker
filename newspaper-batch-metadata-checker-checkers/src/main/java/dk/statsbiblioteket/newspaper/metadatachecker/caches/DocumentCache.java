...
public class DocumentCache {
    ...
    public TimeSensitiveCache<String,Document> documentCache = new TimeSensitiveCache<>(10000,true,200);
    ...
    private Document parseDocument(AttributeParsingEvent event) throws IOException {
        Document document;
