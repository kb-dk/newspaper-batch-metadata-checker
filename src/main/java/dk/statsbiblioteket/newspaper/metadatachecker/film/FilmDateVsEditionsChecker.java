...
public class FilmDateVsEditionsChecker extends XmlAttributeChecker {
    ...
    public FilmDateVsEditionsChecker(
    ...
    public void validate(AttributeParsingEvent event, Document filmMetaData) {
            ...
            NodeList editions = xPathSelector.selectNodeList(batchXmlStructure,
    ...
    protected void verifyEditionDateContainment(
            String filmStartdate, String filmEnddate, String editionID, String filmID, AttributeParsingEvent event) {
        ...
        if (filmStart.compareTo(editionDate) > 0) {
            addFailure(event, "2E-2: Edition earlier than film start date " + filmStartdate + " in film " + filmID);  // Include filmid
        }
